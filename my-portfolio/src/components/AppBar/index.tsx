...
const pages = ['experience', 'education', 'skills', 'more'];
      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters sx={{ alignItems: 'center' }}>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
            ...
            >
              {pages.map((page) => (
                <MenuItem key={page} onClick={() => handleNavLinkClick(page.toLowerCase())}
                onTouchStart={() => handleNavLinkClick(page.toLowerCase())}
                >
